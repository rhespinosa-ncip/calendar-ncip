                ...
                <form id="login-form">
                    ...
                    <div class="row">
                        <div class="col-12 mt-2 text-center">
                            <h3 class="font font-weight-bold">Sign in to Account</h3>
                            <hr>
                        </div>
                        ...
                        <div class="col-8 offset-2 mt-5">
                            <div class="form-group row mb-1">
                                <label class="has-float-label col-12 p-0">
                                    <input class="form-control rounded-0" type="text" id="username" name="username"/>
                                    <span class="span-credential-key" style="background: #eef !important;">Username</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-8 offset-2 mt-2">
                            <div class="form-group row">
                                <label class="has-float-label col-12 p-0">
                                    ...
                                    <span class="span-credential-password" style="background: #eef !important;">Password</span>
                    ...
                    <div class="row">
                        <div class="col-8 offset-2 text-center mt-3">
                            <button type="submit" form="login-form" class="btn btn-primary btn-block login-form pr-sm-5 pl-sm-5 rounded-0"><b> Sign In </b></button>
                        </div>
                    </div>
                </form>
                <div class="row mt-3">
