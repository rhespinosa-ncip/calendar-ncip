    ...
    <div class="container-fluid mb-5">
         <div class="row mt-4">
            <div class="col-12 text-right mb-4">
                <button class="btn btn-success rounded-0 py-1 px-3 btn-tito-filter"><i class="fa fa-filter" aria-hidden="true"></i>  Filter</button>
            ...
            <div class="card rounded-0">
                <div class="card-body" id="printAreaReports">
                    ...
                    <div class="content-report">
                        @include('auth.report.tito.content')
                    </div>
                    <div class="row mt-4">
                        @include('prepared-by')
                    </div>
